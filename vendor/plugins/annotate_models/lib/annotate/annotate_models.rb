    ...
    def annotate(klass, file, header,options={})
      ...
      unless ENV['exclude_tests']
        [
          ...
          # Add an option "position_in_test" -- or maybe just ask if anyone ever wants different positions for model vs. test vs. fixture -> This came with code (HF)
    ...
    def do_annotations(options={})
      ...
      get_model_files.each do |file|
        begin
          ...
          puts ""
# Check if all backtrace lines are in "gems" -- if so, it's an annotate bug, so print the whole stack trace. -> This came with code (HF)
